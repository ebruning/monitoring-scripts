...
get_ipmi_data () {
    ...
    while [  $COUNTER -lt 4 ]; do
        #Get ipmi data
        ipmitool -H 172.16.1.233 -U ethan -P lighthouse sdr > tempdatafile
...
write_data () {
    ...
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=cputemp value=$cputemp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=systemtemp value=$systemtemp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=periphtemp value=$periphtemp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=pchtemp value=$pchtemp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=vrmtemp value=$vrmtemp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=dimma1temp value=$dimma1temp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=dimma2temp value=$dimma2temp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=dimmb1temp value=$dimmb1temp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=dimmb2temp value=$dimmb2temp"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=fan2 value=$fan2"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=fan3 value=$fan3"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=fan4 value=$fan4"
    curl -i -XPOST 'http://localhost:8086/write?db=home' --data-binary "health_data,host=proxmox,sensor=fana value=$fana"
}
